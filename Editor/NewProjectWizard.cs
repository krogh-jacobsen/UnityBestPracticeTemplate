...
namespace Unity.BestPractices.Editor
{
    ...
    public class NewProjectWizard : EditorWindow
    {
        ...
        [MenuItem("Tools/Unity Project Configurator/New Project Wizard", false, 20)]
        ...
        private void DrawSteps()
        {
            ...
            DrawStep(
                ...
                false,
                "Run",
                () => EditorApplication.ExecuteMenuItem("Tools/Unity Project Configurator/Setup/Setup Tags and Layers")
            );
